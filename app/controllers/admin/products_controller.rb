class Admin::ProductsController < AdminController
  ...
  def index
    ...
    @admin_products=@admin_products.page(params[:page]).per(6)
  end
  ...
  def admin_product_params
    params.require(:product).permit(:name, :description, :price, :category_id, :classification, :product_image, product_variants: [])
  end
end
